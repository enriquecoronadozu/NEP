...
countrynames = ( 'あらた　ゆうき くん','とみやま　ここね　ちゃん','まつもと　ひとし　くん', \
                 'みやざき　あんな　ちゃん','とりやま　かなと　くん','すみうえ　りこ　ちゃん', \
                 'わたなべ　けんせい　くん','そや　あきのぶ　くん','いっしき　たける　くん', \
                 'あおき　みさき　ちゃん','あおき　ゆず　ちゃん','みうら　みゆう　ちゃん', \
                 'むらまつ　れん　くん','いわさき　そうま　くん','まつだ　さな　ちゃん', \
                 'まつやま　なおき　くん','あいた　みゆ　ちゃん','うえた　ひろと　くん',\
                 'すどう　とき　くん','おにき　ひなた　くん','ともひろ　あずさ　ちゃん')
...
lbox = Listbox(c, listvariable=cnames, height=21)
...
def onTest():
    ...
    while True:
        ...
        if triangle[0] == False and triangle[1] == True:
            ...
            triangle[0] =  triangle[1]
            msg = "おやすみ　ですね！"
            r.do_parallel_actions(["say_contextual",msg], {"language":"Japanese"},["nao"])
            
        if circle[0] == False and circle[1] == True:
            print "change circle"
            circle[0] =  circle[1]
            msg = ""
            r.do_parallel_actions(["animation","doko"], {"time":1, "flip": False},["nao"])
        ...
        if X[0] == False and X[1] == True:
            ...
            X[0] =  X[1]
            msg = ""
            r.do_parallel_actions(["animation","doko"], {"time":1, "flip": True},["nao"])
