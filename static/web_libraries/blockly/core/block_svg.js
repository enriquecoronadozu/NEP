...
Blockly.BlockSvg.prototype.updateColour = function() {
  ...
  if (this.isShadow()) {
    ...
    this.svgPathDark_.setAttribute('fill-opacity', '0');
  } else {
    this.svgPathLight_.style.display = '';
    var hexLight = goog.color.rgbArrayToHex(goog.color.lighten(rgb, 0)); //ENRIQUE: flat design
    ...
    this.svgPathDark_.setAttribute('fill-opacity', '0.1'); //ENRIQUE: flat design
  }
  this.svgPath_.setAttribute('fill', hexColour);
  this.svgPath_.setAttribute('fill-opacity', '9'); //ENRIQUE: flat design
